...
public class PersonOverviewController {
    ...
    private void handleDeletePerson() {
        ...
        int UUIDIndex = 7;
        if (selectedIndex >= 0) {
        	UUID perID = (UUID) getValueAt(personTable, UUIDIndex, selectedIndex);
    ...
    public static Object getValueAt(TableView table, int column, int row) {
        return ((TableColumn<Person, String>) table.getColumns().get(column)).getCellObservableValue(row).getValue();
    }
